...
const Home = ()=>{
    const enablechatdiv = ()=>{
        ...
        if(document.getElementsByClassName("botchatbox")[0].style.display === 'none' || !document.getElementsByClassName("botchatbox")[0].style.display){
            ...
            document.getElementsByClassName("botsmenu")[0].style.display = 'none';
    ...
    const back = ()=>{
        ...
        document.getElementsByClassName("botsmenu")[0].style.display = 'block';
                    ...
                    <div className="homecontainer">
                        ...
                        <div className="createroom">
                            <div className="subcreateroom">
                                <span class="material-symbols-outlined" onClick={cancelcreateroom}>chevron_left</span>
                                {/* <span class="material-symbols-outlined" onClick={cancelcreateroom}>close</span> */}
